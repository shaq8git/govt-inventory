            ...
            <table className="min-w-full border-separate border-spacing-0 text-sm">
              <thead className="bg-slate-50 text-xs font-semibold uppercase tracking-wide text-slate-500">
                <tr>
                  ...
                  <th className="w-24 border-b border-slate-200 px-3 py-3 text-center">Quantity</th>
                  <th className="w-28 border-b border-slate-200 px-3 py-3 text-center">Pur. Rate</th>
                  <th className="w-28 border-b border-slate-200 px-3 py-3 text-center">Sales Rate</th>
                  <th className="w-24 border-b border-slate-200 px-3 py-3 text-center">MRP</th>
