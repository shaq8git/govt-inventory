  ...
  return (
    ...
    <main className="min-h-screen bg-red text-slate-900" style={{ backgroundColor: '#ffffff' }}>
          ...
          >
            ...
            <div className="flex items-end">
              <button
                type="submit"
                disabled={saving}
                className="h-11 rounded-md bg-slate-950 px-5 text-sm font-semibold text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-300"
              >
                {saving ? "Saving" : "Add"}
              </button>
            </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8">
        ...
        <div className="overflow-hidden rounded-lg border border-slate-400 bg-gray-900 shadow-sm">
              ...
              <tbody>
                {loading ? (
                  ...
                  filteredItems.map((item) => {
                    ...
                    return (
                      <tr key={rowKey} className="odd:bg-white even:bg-gray-400">
                        ...
                        <td className="border-b border-slate-100 px-3 py-2">
                          <button
                            ...
                            className="h-9 rounded-md bg-slate-950 px-3 text-xs font-semibold text-white transition hover:bg-cyan-700 disabled:cursor-not-allowed disabled:bg-slate-400"
                          >
