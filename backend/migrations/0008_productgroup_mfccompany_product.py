    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('productgroup', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='products', to='backend.productgroup')),
                ('mfccompany', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='products', to='backend.mfccompany')),
